                  ...
                  children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          _NavItem(
                            ...
                            label: 'Home',
                            color: _colorFor(currentIndex == 0),
                          ...
                          _NavItem(
                            ...
                            label: 'Chat',
                            color: _colorFor(currentIndex == 1),
                    ...
                    Expanded(
                      child: Row(
                        ...
                        children: [
                          _NavItem(
                            icon: currentIndex == 5 ? Icons.timeline : Icons.timeline_outlined,
                            label: 'History',
                            color: _colorFor(currentIndex == 5),
                            selected: currentIndex == 5,
                            onTap: () => _go(context, 5),
                          ),
                          _NavItem(
                            icon: currentIndex == 6 ? Icons.person : Icons.person_outline,
                            label: 'Profile',
                            color: _colorFor(currentIndex == 6),
...
class _BurgerButton extends StatelessWidget {
  ...
  final Color fg;
  const _BurgerButton({required this.onPressed, this.onLongPress, required this.fg});
