...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  Future<void> _handleContinue() async {
    switch (_stage) {
      ...
      case _Stage.voiceSelect:
        ...
        break;
      case _Stage.disclaimer:   await _goToStage(_Stage.privacy);      break;
      case _Stage.privacy:      await _goToStage(_Stage.notifications);break;
  ...
  Widget _buildStage(TextTheme tt, bool isDark) {
    switch (_stage) {
      ...
      case _Stage.privacy:      return _buildPrivacyStage(tt, isDark);
  ...
  // ── Stage 7: Privacy & Transparency ──────────────────────────────────────
  Widget _buildPrivacyStage(TextTheme tt, bool isDark) {
    final subtleColor = isDark
        ? Colors.white.withValues(alpha: 0.60)
        : const Color(0xFF475467);
    return Padding(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 10),
          Text(
            'Everything you share stays between you and your AI companion. Here\u2019s exactly what that means.',
            textAlign: TextAlign.center,
            style: tt.bodyMedium?.copyWith(color: subtleColor, height: 1.55),
          ),
          const SizedBox(height: 24),
          Expanded(
            child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    _DisclaimerRow(
                      ...
                      title: 'Conversations stay on your device',
                      body: 'Your chat history is stored locally. It never leaves your phone.',
                      tt: tt, isDark: isDark,
                    ),
                    const SizedBox(height: 14),
                    _DisclaimerRow(
                      ...
                      body: 'We never show advertisements, sell your data, or share it with third-party marketers.',
                      tt: tt, isDark: isDark,
                    ),
                    const SizedBox(height: 14),
                    _DisclaimerRow(
                      ...
                      title: 'Your words never train AI',
                      body: 'Nothing you say is used to train, fine-tune, or improve any AI model.',
                      tt: tt, isDark: isDark,
                    ),
                    const SizedBox(height: 14),
                    _DisclaimerRow(
                      ...
                      title: 'Voice recordings are never stored',
                      body: 'Voice sessions are processed in real time and immediately discarded.',
                      tt: tt, isDark: isDark,
                    ),
                  ],
                ),
          ...
          const SizedBox(height: 10),
          Text(
            'You can review full privacy details anytime in Settings \u2192 Trust & Safety.',
            textAlign: TextAlign.center,
            style: tt.bodySmall?.copyWith(
              color: isDark
