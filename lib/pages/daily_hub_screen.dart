...
class _DailyHubScreenState extends State<DailyHubScreen>
          ...
          build: (ctx) {
            return pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  pw.Text('MindReset AI',
                      style: pw.TextStyle(
                          fontSize: 18,
                          fontWeight: pw.FontWeight.bold,
                          color: PdfColors.blueGrey800)),
                  pw.SizedBox(height: 6),
                  pw.Text('Journal Book',
                      style: pw.TextStyle(
                  ...
                  pw.Text('Monthly Reflection Snapshot',
                      style: pw.TextStyle(
                          fontSize: 13,
                          fontWeight: pw.FontWeight.bold,
                          color: PdfColors.blueGrey800)),
                  ...
                  pw.Row(
                    ...
                    children: [
                      _pdfStat('Days written',
                          '${summary.daysWithEntries}', PdfColors.blueGrey800),
                      _pdfStat('Entries',
                          '${summary.totalEntries}', PdfColors.blueGrey800),
                      _pdfStat('Current streak',
                          '${summary.streak} days', PdfColors.blueGrey800),
                    ],
                  ),
  ...
  // ── MindCore Insight Card ─────────────────────────────────────────────────
  // Affirmation removed — shows: Summary, Micro-step, Reflection prompt only
