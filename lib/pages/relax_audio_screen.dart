...
class _RelaxAudioScreenState extends State<RelaxAudioScreen>
  ...
  final List<RelaxTrack> _tracks = const [
    ...
    RelaxTrack(id: 'digital_detox_reset', title: 'Digital Detox Reset', subtitle: 'Step away from screens and clear mental overload.', assetPath: 'audio/Digital Detox Reset.mp3'),
    RelaxTrack(id: 'empowering_affirmations', title: 'Empowering Affirmations', subtitle: 'Positive statements to rebuild self-belief.', assetPath: 'audio/Empowering Affirmations.mp3'),
    RelaxTrack(id: 'evening_wind_down', title: 'Evening Wind Down', subtitle: 'Let go of the day and prepare for deep rest.', assetPath: 'audio/Evening Wind Down.mp3'),
    RelaxTrack(id: 'gratitude_moment', title: 'Gratitude Moment', subtitle: 'Shift into appreciation and calm perspective.', assetPath: 'audio/Gratitude Moment.mp3'),
    RelaxTrack(id: 'grief_soother', title: 'Grief Soother', subtitle: 'Gentle support for heavy, grieving moments.', assetPath: 'audio/Grief Soother.mp3'),
    RelaxTrack(id: 'morning_mind_reset', title: 'Morning Mind Reset', subtitle: 'Start your day clear, calm and focused.', assetPath: 'audio/Morning Mind Reset.mp3'),
    RelaxTrack(id: 'morning_motivation_boost', title: 'Morning Motivation Boost', subtitle: 'Light a fire under your goals with calm energy.', assetPath: 'audio/Morning Motivation Boost.mp3'),
    RelaxTrack(id: 'overthinking_reset', title: 'Overthinking Reset', subtitle: 'Step out of your head and back into the present.', assetPath: 'audio/Overthinking Reset.mp3'),
    RelaxTrack(id: 'panic_calmer', title: 'Panic Calmer', subtitle: 'Short grounding track for intense anxiety spikes.', assetPath: 'audio/Panic Calmer.mp3'),
    RelaxTrack(id: 'reset_after_conflict', title: 'Reset After Conflict', subtitle: 'Settle your body and mind after arguments or tension.', assetPath: 'audio/Reset After Conflict.mp3'),
    RelaxTrack(id: 'self_compassion_moment', title: 'Self-Compassion Moment', subtitle: 'Practice kindness with yourself when you feel low.', assetPath: 'audio/Self Compassion Moment.mp3'),
    RelaxTrack(id: 'self_compassion', title: 'Self-Compassion', subtitle: 'Deeper self-compassion practice for emotional healing.', assetPath: 'audio/Self Compassion.mp3'),
    RelaxTrack(id: 'sleep_transition_session', title: 'Sleep Transition Session', subtitle: 'Drift from alertness into sleep-ready calm.', assetPath: 'audio/Sleep Transition Session.mp3'),
    RelaxTrack(id: 'social_overwhelm_reset', title: 'Social Overwhelm Reset', subtitle: 'Come down gently after intense social situations.', assetPath: 'audio/Sociall Overwhelm Reset.mp3'),
              ...
              GlassCard(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Choose a session, press play, and let it run while you breathe, journal, or simply rest.', style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: cs.onSurface.withValues(alpha: 0.7))),
                    if (_recommendedTrackTitle != null) ...[
                      ...
                      Container(
                        ...
                        child: Text('Recommended: $_recommendedTrackTitle', style: Theme.of(context).textTheme.labelMedium?.copyWith(color: cs.primary, fontWeight: FontWeight.w700)),
                      ),
                      if (_recommendedFrequencyLabel != null || _recommendedTrackSubtitle != null) ...[
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(color: cs.surface, borderRadius: BorderRadius.circular(16), border: Border.all(color: cs.outlineVariant.withValues(alpha: 0.35))),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight,
            colors: isActive ? [cs.primary.withValues(alpha: 0.11), cs.surface.withValues(alpha: 0.96)] : [cs.surface.withValues(alpha: 0.96), cs.surface.withValues(alpha: 0.90)]),
                ...
                children: [
                  ...
                  Row(children: [
                    Container(
                      ...
                      decoration: BoxDecoration(color: isActive ? cs.primary.withValues(alpha: 0.10) : cs.surfaceContainerHighest.withValues(alpha: 0.65), borderRadius: BorderRadius.circular(999)),
      ...
      child: InkWell(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight,
              colors: isActive ? const [Color(0xFF5C8EFF), Color(0xFF78C9FF)] : [cs.surfaceContainerHighest.withValues(alpha: 0.92), cs.surfaceContainer.withValues(alpha: 0.96)]),
            boxShadow: [BoxShadow(color: isActive ? const Color(0xFF5C8EFF).withValues(alpha: 0.24) : Colors.black.withValues(alpha: 0.05), blurRadius: isActive ? 24 : 14, offset: const Offset(0, 8))],
            border: Border.all(color: isActive ? Colors.white.withValues(alpha: 0.18) : cs.outlineVariant.withValues(alpha: 0.16)),
          ),
          child: Icon(isPlaying ? Icons.pause_rounded : Icons.play_arrow_rounded, size: 30, color: isActive ? Colors.white : cs.onSurface.withValues(alpha: 0.72)),
        ),
      ),
    );
  }
