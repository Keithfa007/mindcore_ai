        ...
        children: [
          GlassCard(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            if (_recommendedTrackTitle != null) ...[
              ...
              Container(padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8), decoration: BoxDecoration(color: cs.primary.withValues(alpha: 0.08), borderRadius: BorderRadius.circular(999)), child: Text('Recommended: $_recommendedTrackTitle', style: Theme.of(context).textTheme.labelMedium?.copyWith(color: cs.primary, fontWeight: FontWeight.w700))),
  ...
  Widget build(BuildContext context) {
    ...
    return SurfaceCard(padding: EdgeInsets.zero, child: AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: isActive ? [cs.primary.withValues(alpha: 0.11), cs.surface.withValues(alpha: 0.96)] : [cs.surface.withValues(alpha: 0.96), cs.surface.withValues(alpha: 0.90)]),
...
class _MediaControlButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final cs = Theme.of(context).colorScheme;
    return Material(color: Colors.transparent, child: InkWell(onTap: onTap, borderRadius: BorderRadius.circular(999), child: AnimatedContainer(
      duration: const Duration(milliseconds: 220), width: 62, height: 62,
      decoration: BoxDecoration(
        shape: BoxShape.circle,
        gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: isActive ? const [Color(0xFF5C8EFF), Color(0xFF78C9FF)] : [cs.surfaceContainerHighest.withValues(alpha: 0.92), cs.surfaceContainer.withValues(alpha: 0.96)]),
