...
# - Adds fade in/out
# - Outputs 9:16 vertical MP4 optimised for TikTok/Facebook
ffmpeg_cmd = [
    "ffmpeg", "-y",
    ...
    "-vf", (
        ...
        "crop=1080:1920,"
        "fade=t=in:st=0:d=0.5,"    # 0.5s fade in
        "fade=t=out:st=4.5:d=0.5"  # 0.5s fade out at end
    ),
    "-c:v", "libx264",
    "-preset", "fast",
    "-crf", "23",
...
# ── Save caption file alongside video ─────────────────────────────────────
...
# Write filename to env file for GitHub Actions upload step
