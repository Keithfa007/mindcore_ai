...
- Total length: 40-70 words. 15-25 seconds spoken.
- First person OR direct address ("you"). Raw. Honest. No filter.
- Each sentence works as standalone text on screen.
- NO emojis, NO hashtags, NO "hey guys", NO motivational cliches.
- Do NOT start with "I" more than twice.
- First sentence must hit IMMEDIATELY. No setup. Punch first.
