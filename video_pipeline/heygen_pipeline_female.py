...
def generate_content_script(topic,client):
    ...
    lo_hook,hi_hook=WORD_TARGETS_CONTENT["hook"];lo_prob,hi_prob=WORD_TARGETS_CONTENT["problem"]
...
def render_avatar_video(script_text,cfg):
    ...
    raw_path=str(OUTPUT_DIR/"mindcore_female_raw.mp4");final_path=str(OUTPUT_DIR/"mindcore_female_video.mp4")
