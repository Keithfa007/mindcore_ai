...
def research_topic():
    ...
    response = anthropic_client.messages.create(
        ...
        messages=[{
            "role": "user",
            "content": """You are an expert SEO strategist specialising in mental wellness content.
...
# ── Step 5 · Publish to WordPress as Draft ────────────────────────────────────
...
def main():
    ...
    # 4. Publish
    publish_to_wordpress(topic_data, content, image_id)
